...
const Sidebar = () => {
  ...
  const renderIcon = (linkName, isActive) => {
    const color = isActive ? "#6A7BFF" : "#7a8fa8";
      ...
      case 'History':
        return (
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M3.05 11C3.27151 8.68261 4.51919 6.56428 6.48114 5.16043C8.44309 3.75659 10.9422 3.18535 13.3551 3.57183C15.768 3.95832 17.9031 5.26647 19.2766 7.20749C20.6501 9.14851 21.1458 11.5524 20.6517 13.8508C20.1576 16.1493 18.7172 18.1729 16.6826 19.4841C14.6481 20.7953 12.1868 21.2906 9.80617 20.8739C7.42556 20.4572 5.31217 19.1621 3.90283 17.2225C2.49349 15.2829 1.89913 12.8612 2.22 10.46" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        );
      case 'Calendar':
        return (
      ...
      <nav className="sidebar-menu">
        <ul>
          {navLinks.map((link) => (
            ...
            >
              <span className="menu-icon-placeholder">
                {renderIcon(link.name, link.name === activeLink)}
              </span>
